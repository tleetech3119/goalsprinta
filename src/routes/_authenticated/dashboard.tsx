...
import { Plus, Target, ArrowRight, Calendar } from "lucide-react";
  ...
  return (
    <div className="container mx-auto max-w-6xl px-6 py-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl font-bold">Your sprints</h1>
          <p className="mt-1 text-sm text-muted-foreground">Focused cycles toward the goals that matter.</p>
        </div>
        <Button
