    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-md px-6 py-12">
        <Card className="border-border bg-card p-8 shadow-card">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to start sprinting toward your goals.</p>
          ...
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signin">
              <form onSubmit={signIn} className="space-y-3">
                ...
                <Button type="submit" disabled={loading} className="w-full bg-gradient-primary text-primary-foreground">{loading ? "..." : "Sign in"}</Button>
              </form>
            </TabsContent>
            <TabsContent value="signup">
              <form onSubmit={signUp} className="space-y-3">
                ...
                <Button type="submit" disabled={loading} className="w-full bg-gradient-primary text-primary-foreground">{loading ? "..." : "Create account"}</Button>
              </form>
            </TabsContent>
          </Tabs>
        </Card>
